...
%  Mit Unterstützung von = {Harry Hilfreich},
  ...
  Abstract              = {
    ...
    The Meteor stegosystem extends classical steganographic primitives for use on ML-based channels such as the generative model GPT-2.
    ...
    This is due to ambiguous tokenization of text, which can occur with subword tokenization, a feature of modern generative models.
  ...
  Zusammenfassung       = {
    ...
    Das Meteor-Stegosystem erweitert klassische steganographische Primitive für die Verwendung auf ML-basierten Kanälen wie etwa dem generativen Modell \mbox{GPT-2}.
    ...
    Dies geschieht aufgrund uneindeutiger Tokenisierung von Text, welche bei Subword-Tokenisierung, einem Feature moderner generativer Modelle, auftreten kann.
    ...
    Außerdem wird eine Modifikation diskutiert, mit der das Meteor-Stegosystem zur überzeugenderen Verwendung im Kontext von Instant Messaging verwendet werden kann.
  },
  %
