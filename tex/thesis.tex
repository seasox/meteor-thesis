...
For a comparison of GNN model outputs, see examples \autoref{example:gpt2-output} and \autoref{example:gpt2-output-sample}.
...
A Python program which generates the outputs in \autoref{example:gpt2-output} and \autoref{example:gpt2-output-sample} can be found at \autoref{code:gpt2-demo}.
