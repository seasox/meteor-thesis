...
%  Mit Unterstützung von = {Harry Hilfreich},
  ...
  %
  Abstract              = {
    Steganography enables confidential communication even if the use of cryptography is prevented or impeded.
    The Meteor stegosystem extends classical steganographic primitives for use on channels based on generative ML models, such as GPT-2.
    In the Meteor stegosystem, the hiddentext is embedded in the randomness used in sampling from the generative model.
    
    In this thesis, we analyze reliability and security against chosen hiddentext attackers of the Meteor stegosystem. 
    We will find that Meteor is not reliable, especially for longer hiddentexts.
    ...
    We present modifications that improve the reliability and security against chosen hiddentext attackers of the Meteor stegosystem.
    We also discuss a modification that enables us to use the Meteor stegosystem for more compelling use in the context of instant messaging.
  },
  Zusammenfassung       = {
    Steganographie ermöglicht vertrauliche Kommunikation auch dann, wenn die Nutzung von Kryptographie verhindert oder erschwert wird.
    Das Meteor-Stegosystem erweitert klassische steganographische Primitive für die Verwendung auf Kanälen, die auf generativen ML-Modellen basieren, wie etwa \mbox{GPT-2}.
    Im Meteor-Stegosystem wird der Geheimtext in den verwendeten Zufall im Sampling des generativen Modells eingebettet.
    
    In dieser Arbeit werden Zuverlässigkeit sowie Sicherheit gegen Chosen-Hiddentext-Angriffe des Meteor-Stegosystems untersucht. 
    Wir werden feststellen, dass die Zuverlässigkeit insbesondere bei längeren Geheimtexten verletzt ist.
    Dies geschieht aufgrund uneindeutiger Tokenisierung von Text, welche bei Subword-Tokenisierung, einem Feature moderner generativer Modelle wie etwa GPT-2, auftreten kann.
    Zudem ist das Meteor-Stegosystem deterministisch und dadurch verwundbar gegen Chosen-Hiddentext-Angriffe mit Querykomplexität größer als eins.
    Wir präsentieren Modifikationen, die die Zuverlässigkeit und Sicherheit gegen Chosen-Hiddentext-Angriffe des Meteor-Stegosystems verbessern.
    Außerdem wird eine Modifikation präsentiert, mit der das Meteor-Stegosystem zur überzeugenderen Verwendung im Kontext von Instant Messaging verwendet werden kann.
  },
  %
  ...
  %
  Acknowledgements = {
  I would like to express my sincere thanks to Prof. Dr. Maciej Liśkiewicz for sparking my interest in the topic at hand and enabling me to write this thesis.
  Our meetings and conversations have helped me tremendously to approach the highly interesting topic of steganography and to formalize my sometimes vague thoughts.
  
  I am also grateful for my fellow students, for their editing help and late-night feedback sessions.
  
  Lastly, I would like to thank my parents Viola and Torsten for their continued love and support.
  Without you, my studies would not have been possible.
  },
