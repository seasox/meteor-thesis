...
The Meteor authors have released a demo of Meteor at \cite{MeteorDemo2021}. There, they state that ``Note that, due to issues with the GPT-2 algorithm interface, you sometimes may see extra output from a decoded stegotext. This does not impact the underlying security of the scheme''.
...
In \autoref{sec:generative-neural-networks}, we have discussed that GPT-2 uses a token dictionary to represent text.
