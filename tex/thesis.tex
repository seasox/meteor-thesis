...
We will also discuss how an attacker can distinguish Meteor's output from a random oracle $/mathcal{O}$ using polynomial queries, time and message length.
...
The Meteor authors have released a demo of Meteor at \cite{MeteorLiveDemo2021}. There, they state that ``Note that, due to issues with the GPT-2 algorithm interface, you sometimes may see extra output from a decoded stegotext. This does not impact the underlying security of the scheme.''.
During experimentation, I have concluded that the cause of this is
...
@misc{MeteorDemo2021,
	...
	month = {08},
	day = {24},
	howpublished = {\hyperlink{https://colab.research.google.com/gist/tusharjois/ec8603b711ff61e09167d8fef37c9b86}},
