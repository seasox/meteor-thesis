...
\UzLThesisSetup{
  ...
  %
  Titel auf Deutsch     = {
     Sichere Steganographie auf ML-Basierten Kanälen (Draft v0)
  }, 
  Titel auf Englisch    = {
    Secure Steganography on ML-Based Channels (Draft v0)
  },
  %
...
%  Mit Unterstützung von = {Harry Hilfreich},
  ...
  Abstract              = {
	...
	This can occur when using subword tokens, which are used in modern generative models such as GPT-2.
    In addition, the Meteor stegosystem is vulnerable to chosen-hidden-text attackers with polynomially many queries.
  ...
  Zusammenfassung       = {
    ...
    Diese kann bei Verwendung von Subword-Tokens, welche in modernen Generativen Modellen wie etwa GPT-2, auftreten.
    Zudem ist das Meteor-Stegosystem verwundbar gegen Chosen-Hiddentext-Angreifer mit polynomiell vielen Queries.
  ...
  %
  Acknowledgements = {
	First and foremost, I'd like to thank Prof. Dr. Maciej Liśkiewicz for sparking my interest in the topic at hand and giving me the opportunity to write this thesis.
	...
	I also want to thank my parents Viola and Torsten, who have always supported me on my ways.
  },
...
\newcommand{\leftarrowS}{\leftarrow\smalldollar}
