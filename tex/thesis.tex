...
%  Mit Unterstützung von = {Harry Hilfreich},
  ...
  Zusammenfassung       = {
    ...
    In dieser Thesis werden Zuverlässigkeit sowie Sicherheit gegen Chosen-Hiddentext-Angreifer des Meteor-Stegosystems analysiert. 
    Wir werden feststellen, dass die Zuverlässigkeit insbesondere bei längeren Geheimtexten ($|m| \geq 1024$ Bytes) verletzt ist.
    Diese passiert aufgrund uneindeutiger Tokenisierung von Text, welche bei Subword-Tokenisierung, einem Feature moderner generativer Modelle wie etwa GPT-2, auftreten kann.
