...
For an example of GNN model outputs using sampling, see \exampleref{example:gpt2-output-sample}.
...
A Python program which generates the outputs in \exampleref{example:gpt2-output-sample} can be found at \autoref{code:gpt2-demo}.
...
Recover produces, given a history $h$ and a value $r$, 
}]
